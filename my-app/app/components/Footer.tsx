    ...
    <footer className="bg-[#282828] p-8 text-left text-white flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col items-start md:items-end mr-0 md:mr-20 mt-8 md:mt-8">
        <div className="flex space-x-4 mb-4">
          <a href="/blog">
            <img src="/blog_icon.png" alt="Blog" className="w-8 h-8" />
          </a>
          <a href="/facebook">
            <img src="/facebook_icon.png" alt="Facebook" className="w-8 h-8" />
          </a>
          <a href="/instagram">
            <img src="/insta_icon.png" alt="Instagram" className="w-8 h-8" />
          </a>
          <a href="/education">
            <img src="/edu_icon1.png" alt="Education" className="w-8 h-8" />
          </a>
        </div>
